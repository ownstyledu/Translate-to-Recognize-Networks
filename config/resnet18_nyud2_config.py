...
class RESNET18_SUNRGBD_CONFIG:
    ...
    def args(self):
        ...
        content_layers = '0,1,2,3,4' # layer-wise semantic layers
        ...
        log_path = os.path.join(args['ROOT_DIR'], 'nyud2', modality, content_pretrained,
        ...
        return {
            ...
            #### DATA
            'DATA_DIR_TRAIN': '/home/dudapeng/workspace/datasets/nyud2/conc_data/train',
            'DATA_DIR_VAL': '/home/dudapeng/workspace/datasets/nyud2/conc_data/test',
            'NUM_CLASSES': 10,
            'UNLABELED': unlabeled,
